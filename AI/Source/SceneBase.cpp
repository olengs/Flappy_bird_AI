...
void SceneBase::Init()
{
	...
	meshList[GEO_LINE_RED] = MeshBuilder::GenerateLine("line", Color(1,0,0), 1.f);
	meshList[GEO_LINE_GREEN] = MeshBuilder::GenerateLine("line", Color(0, 1, 0), 1.f);
	...
	meshList[GEO_SHARK_HAPPY] = MeshBuilder::GenerateQuad("happy shark", Color(1, 1, 1));
	meshList[GEO_SHARK_HAPPY]->textureID = LoadTGA("Image//happy.tga");
	meshList[GEO_SHARK_CRAZY] = MeshBuilder::GenerateQuad("crazy shark", Color(1, 1, 1));
	...
	meshList[GEO_FISH_DEAD] = MeshBuilder::GenerateQuad("dead fish", Color(1, 1, 1));
	meshList[GEO_FISH_DEAD]->textureID = LoadTGA("Image//dead.tga");
	meshList[GEO_FISH_HUNGRY] = MeshBuilder::GenerateQuad("hungry fish", Color(1, 1, 1));
	meshList[GEO_FISH_HUNGRY]->textureID = LoadTGA("Image//hungry.tga");
	meshList[GEO_FISH_FULL] = MeshBuilder::GenerateQuad("full fish", Color(1, 1, 1));
	meshList[GEO_FISH_FULL]->textureID = LoadTGA("Image//full.tga");
	meshList[GEO_FISH_TOOFULL] = MeshBuilder::GenerateQuad("too full fish", Color(1, 1, 1));
	meshList[GEO_FISH_TOOFULL]->textureID = LoadTGA("Image//toofull.tga");
	...
	//meshList[GEO_WHITEQUAD]->textureID = LoadTGA("Image//whitequad.tga");

	meshList[GEO_WHITEHEX] = MeshBuilder::GenerateRing("whitehex", Color(1, 1, 1), 6, 0.5f, 0.f);

	meshList[GEO_BG2] = MeshBuilder::GenerateQuad("bg", Color(1, 1, 1));
	meshList[GEO_BG2]->textureID = LoadTGA("Image//background-day.tga");
